...
**Rules to Execute**:
1. `@nestjs_tool_installer` (MANDATORY: Installs Node.js, nvm, required CLI tools)
...
3. Execute `@nestjs_version_validator` rule to verify nvm setup and comprehensive dependency management
...
Goal: Identify sensitive files, check .gitignore coverage, find dependency scanning configuration, analyze authentication/authorization patterns.
...
- All 9 detailed sections (Tech Stack, Architecture, API Design, Data Layer, Testing, Code Quality, Security, Documentation & Operations, CI/CD)
